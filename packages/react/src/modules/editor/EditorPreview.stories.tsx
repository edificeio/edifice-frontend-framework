...
export const EditPreviewVariant: Story = {
  args: {
    variant: 'outline',
...
export const ReadPreviewVariant: Story = {
  args: {
    variant: 'ghost',
    content: defaultContent,
  },
